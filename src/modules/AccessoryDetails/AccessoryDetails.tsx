    ...
    <div className="bg-white">
      <div className="pt-6">
        ...
        <nav aria-label="Breadcrumb">
          ...
          >
            <li key={accessoryDetails?.category}>
              <div className="flex items-center">
                <a
                  href={accessoryDetails?.category}
            ...
            <li key={accessoryDetails?.subCategory}>
              <div className="flex items-center">
                <a
                  href={accessoryDetails?.subCategory}
                  className="mr-2 text-sm font-medium text-gray-900"
                >
                  {accessoryDetails?.subCategory}
                </a>
                <svg
                  fill="currentColor"
                  width={16}
        ...
        <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
          ...
          {/* <div className="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
            <img
              alt={accessoryDetails.images[1].alt}
              src={accessoryDetails.images[1].src}
              className="aspect-[3/2] w-full rounded-lg object-cover"
            />
            <img
              alt={accessoryDetails.images[2].alt}
              src={accessoryDetails.images[2].src}
              className="aspect-[3/2] w-full rounded-lg object-cover"
            />
          </div>
          <img
            alt={accessoryDetails.images[3].alt}
            src={accessoryDetails.images[3].src}
            className="aspect-[4/5] size-full object-cover sm:rounded-lg lg:aspect-auto"
          /> */}
        </div>

        {/* accessoryDetails info */}
            ...
            <form className="mt-10">
              ...
              <div>
                ...
                <fieldset aria-label="Choose a color" className="mt-4">
                  {/* <RadioGroup value={selectedColor} onChange={setSelectedColor} className="flex items-center gap-x-3">
                    {accessoryDetails.colors.map((color) => (
                      <Radio
                        key={color.name}
                        value={color}
              ...
              <div className="mt-10">
                ...
                <fieldset aria-label="Choose a size" className="mt-4">
                  ...
                  >
                    {accessoryDetails.sizes.map((size) => (
                      <Radio
                        key={size.name}
                        value={size}
            ...
            <div className="mt-10">
              ...
              <div className="mt-4">
                <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
                  {accessoryDetails?.specification?.map((highlight) => (
